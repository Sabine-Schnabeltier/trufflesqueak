...
public final class SqueakImageContext {
    ...
    @TruffleBoundary
    private Object lookupSlow(final ClassObject receiverClass, final NativeObject selector) {        final MethodCacheEntry cachedEntry = findMethodCacheEntry(receiverClass, selector);
