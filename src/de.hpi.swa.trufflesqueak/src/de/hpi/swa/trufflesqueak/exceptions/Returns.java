...
public final class Returns {
    ...
    /**
     * NonLocalReturn represents a return of a returnValue to a targetContext that is on the sender chain.
     */
    ...
    /**
     * CannotReturnToTarget represents a return of a returnValue to a targetContext that cannot be found on the sender chain.
     */
